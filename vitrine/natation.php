...
<div class="container my-5">
    ...
    <div class="row g-5">
        ...
        <div class="col-12 col-md-9">
            ...
            <h1 class="fw-bold text-uppercase mb-4" style="color: #ff6600;">La Section NATATION</h1>

            <img src="img/natation2.jpg" class="img-fluid rounded-3 mb-4" alt="Athlétisme">

            <p class="lead fw-bold">
                Bienvenue dans la section historique du Mouvement Maximal. Depuis 2010, nous formons les athlètes de demain.
            </p>
            <p>
                L'athlétisme est un ensemble d'épreuves sportives codifiées comprenant les courses, sauts, lancers, épreuves combinées et marche. L'origine du mot athlétisme vient du grec "athlon" qui signifie combat. Il s'agit de l'art de dépasser la performance des adversaires en vitesse ou en endurance, en distance ou en hauteur.
            </p>
            <p>
                Que vous soyez débutant cherchant à vous remettre en forme ou compétiteur visnat les podiums régionaux, nos 4 entraîneurs diplômés d'état vous accompagnent sur la piste du stade Charléty.
            </p>
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover border">
                    ...
                    <tbody>
                        <tr>
                            <td>École de natation (6-10 ans)</td>
                            <td>Mercredi</td>
                            <td>14h00 - 15h30</td>
                            <td>Piscine Annexe</td>
                        </tr>
                        <tr>
                            <td>competition </td>
                            <td>Mardi & Jeudi</td>
                            <td>18h30 - 20h30</td>
                            <td>Piscine principal</td>
                        </tr>
                        <tr>
                            <td>Loisir</td>
                            <td>Samedi</td>
