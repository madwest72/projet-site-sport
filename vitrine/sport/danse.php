    ...
    <div class="container my-5">
        ...
        <div class="row g-5">
            ...
            <div class="col-12 col-md-9">
                ...
                <h1 class="fw-bold text-uppercase mb-4" style="color: #ff6600;">La Section DANSE</h1>

                <img src="../img/danse2.jpg" class="img-fluid rounded-3 mb-4" alt="Danse">

                <p class="lead fw-bold">
                    Exprimez votre énergie à travers le mouvement. La danse est l'alliance parfaite entre performance physique et artistique.
                </p>
                <p>
                    La danse est un langage universel où le corps traduit la musique en émotions. Qu'elle soit urbaine, classique ou contemporaine, elle sollicite la souplesse, la mémoire et le sens du rythme. Plus qu'un sport, c'est l'art de sculpter son corps tout en libérant sa créativité et sa confiance en soi sur scène.
                </p>
                <p>
                    Que vous n'ayez jamais esquissé un pas de danse ou que vous prépariez une audition professionnelle, nos chorégraphes passionnés vous accueillent dans nos studios pour vous faire bouger sur tous les tempos.
                </p>
