    ...
    <div class="container my-5">
        ...
        <div class="row g-5">
            ...
            <div class="col-12 col-md-9">
                ...
                <h1 class="fw-bold text-uppercase mb-4" style="color: #ff6600;">La Section Athlétisme</h1>

                <img src="../img/athle2.jpg" class="img-fluid rounded-3 mb-4" alt="Athlétisme">
